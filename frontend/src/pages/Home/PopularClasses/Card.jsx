...
const Card = ({ index, item }) => {
  ...
  return (
    <div
      key={index}
      className="shadow-lg rounded-lg p-3 flex flex-col justify-between border hover:border-2 hover:shadow-xl hover:shadow-blue-400/30 transition-all duration-100 border-secondary dark:border-gray-200 overflow-hidden m-4"
    >
      <img
        src={image}
        alt=""
