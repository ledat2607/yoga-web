  ...
  return (
    <div className="w-[95%] mx-auto mt-6">
      <div className="grid grid-cols-4 gap-3">
        ...
        <div className="flex items-center bg-white border rounded-lg overflow-hidden shadow-sm">
          <div className="p-4 bg-blue-500 w-fit h-full flex items-center">
            <MdBookmark size={25} />
          </div>
          <div className="px-4 text-gray-700">
            <h3 className="text-sm tracking-tighter">Khóa học đã duyệt</h3>
            <p className="text-2xl">{data?.approvedClasses}</p>
          </div>
        </div>
        <div className="flex items-center bg-white border rounded-lg overflow-hidden shadow-sm">
          <div className="p-4 bg-yellow-500 w-fit h-full flex items-center">
            <FaChalkboardTeacher size={25} />
          </div>
          <div className="px-4 text-gray-700">
            <h3 className="text-sm tracking-tighter">Tổng huấn luyện viên</h3>
            <p className="text-2xl">{data?.instructors}</p>
          </div>
        </div>
        <div className="flex items-center bg-white border rounded-lg overflow-hidden shadow-sm">
          <div className="p-4 bg-rose-500 w-fit h-full flex items-center">
            <MdDashboard size={25} />
          </div>
          <div className="px-4 text-gray-700">
            <h3 className="text-sm tracking-tighter">Khóa học chờ duyệt</h3>
            <p className="text-2xl">{data?.pendingClasses}</p>
          </div>
        </div>
      </div>
    </div>
